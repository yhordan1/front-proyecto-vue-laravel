...
<form class="form_main" action="">
    ...
    <input placeholder="Username" id="username" class="inputField" type="email" v-model="usuario.email">
...
<div class="inputContainer">
    ...
    <input placeholder="Password" id="password" class="inputField" type="password" v-model="usuario.password">
